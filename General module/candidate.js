...
const candidateIds = sheetCandidate.getRange("A:A");
const positionIds = sheetPosition.getRange("A:A");
const employeeIds = sheetEmployee.getRange("A:A");
